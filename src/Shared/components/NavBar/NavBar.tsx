	...
	return (
		<nav className="sticky top-0 bg-white border-b  border-slate-900/10 h-16">
			<div className="container flex flex-wrap justify-between items-center mx-auto h-full">
				...
				<div id="navbar-right-container" className="flex">
					{/* <div id="language-toggle" className="w-10 bg-red-500">
						<></>
					</div> */}
					<div className="border-r m-2.5" />
					<a id="github-link" href="https://github.com/Eastrall/ProjectZomboidCharacterPlanner" className="p-2.5 rounded-lg ring-slate-400 hover:bg-gray-100">
					...
					<div id="theme-switch" className="p-2.5 rounded-lg ring-slate-400 hover:bg-gray-100 cursor-pointer">
